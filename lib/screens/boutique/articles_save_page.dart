...
class ArticleSavePage extends StatefulWidget {
  const ArticleSavePage({Key? key}) : super(key: key);
...
class _ArticleSavePageState extends State<ArticleSavePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: myDefaultAppBar('Fiche Article', context),
      body: Center(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      // Image de l'article
                      textRaleway("Image de l'article", 14, Colors.black, TextAlign.center),
