...
class AdminClientCommandePage extends StatefulWidget {
  final Atelier atelier; final Client client;
  const AdminClientCommandePage({Key? key, required this.atelier, required this.client}) : super(key: key);

  @override
  State<AdminClientCommandePage> createState() => _AdminClientCommandePageState();
}

class _AdminClientCommandePageState extends State<AdminClientCommandePage> {
                    ...
                    itemBuilder: (context, int index) => GestureDetector(
                      onTap: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_)=> CommandeDetailsPage(commande: allClientCommandes[index], ligneCmdes: getLigneCommandes(allClientCommandes[index].id!),)
                          )
                        );
                      },
                      child: Container(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            width: 160,
                                            child:  textOpenSans("Cmde ${allClientCommandes[index].id}", 16, kProcouture_green, TextAlign.center, fontWeight: FontWeight.w600),
                                          ),
                                          Container(
                                            width: 80,
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Container(width: 100,alignment: Alignment.centerLeft, child: textOpenSans("${NumberFormat('#,###', 'fr_FR').format(allClientCommandes[index].montant_ttc)} ${widget.atelier.monnaie!.symbole}", 15, Colors.black, TextAlign.center,fontWeight: FontWeight.bold)),
                                        ],
                                      ),
                                      // Montant Regle
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          const SizedBox(width: 4,),
                                          Container(width: 100,alignment: Alignment.centerLeft, child: textOpenSans("${NumberFormat('#,###', 'fr_FR').format(allClientCommandes[index].montant_recu)} ${widget.atelier.monnaie!.symbole}", 15, Colors.black, TextAlign.center,fontWeight: FontWeight.bold)),
                                        ],
                                      ),
                                      // Montant Restant
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          const SizedBox(width: 4,),
                                          Container(width: 100, alignment: Alignment.centerLeft, child: textOpenSans("${NumberFormat('#,###', 'fr_FR').format(allClientCommandes[index].montant_ttc! - allClientCommandes[index].montant_recu!)} ${widget.atelier.monnaie!.symbole}", 15, Colors.black, TextAlign.center,fontWeight: FontWeight.bold)),
                                        ],
                                      ),
                                    ],
                                  )
