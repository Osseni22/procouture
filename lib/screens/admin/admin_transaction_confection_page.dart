...
class AdminTransactionConfectionPage extends StatefulWidget {
  final Atelier atelier;
  const AdminTransactionConfectionPage({Key? key, required this.atelier}) : super(key: key);

  @override
  State<AdminTransactionConfectionPage> createState() => _AdminTransactionConfectionPageState();
}

class _AdminTransactionConfectionPageState extends State<AdminTransactionConfectionPage> {
