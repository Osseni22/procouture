...
class AdminTransactionBanquePage extends StatefulWidget {
  final Atelier atelier; final Banque banque;
  const AdminTransactionBanquePage({Key? key, required this.atelier, required this.banque}) : super(key: key);

  @override
  State<AdminTransactionBanquePage> createState() => _AdminTransactionBanquePageState();
}

class _AdminTransactionBanquePageState extends State<AdminTransactionBanquePage> {
  ...
  Future<void> getAllTransactions() async {
    var request = http.Request('GET', Uri.parse(AdminRoutes.r_getTransactionBanqueCreancierUrl(widget.atelier.id!, widget.banque.id!)));
