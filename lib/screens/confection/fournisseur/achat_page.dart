...
class _AchatPageState extends State<AchatPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: myDefaultAppBar('Achats Fournisseur', context),
      body: Column(
        ...
        children: [
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            width: 160,
                                            child:  textOpenSans('Achat N°${index+1}', 16, Colors.black, TextAlign.center),
                                          ),
                                          Container(
                                            width: 80,
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          textOpenSans('Date achat : ', 13, Colors.black, TextAlign.center),
                                      ...
                                      child: GestureDetector(
                                        ...
                                        child: Container(
                                          ...
                                          child: Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                            children: [
                                              textOpenSans('Paiement', 15, Colors.black, TextAlign.start),
          ...
          Container(
            ...
            child: textRaleway('Fournisseur : Osseni Abdel Aziz', 12, Colors.black, TextAlign.right),
          )
        ],
      ),
