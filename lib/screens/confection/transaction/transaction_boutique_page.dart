...
class TransactionBoutiquePage extends StatefulWidget {
  const TransactionBoutiquePage({Key? key}) : super(key: key);

  @override
  State<TransactionBoutiquePage> createState() => _TransactionBoutiquePageState();
}

class _TransactionBoutiquePageState extends State<TransactionBoutiquePage> {
                                  ...
                                  builder: (ctx) => Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        //(transaction.type_transaction!.libelle!, 16, Colors.black, TextAlign.start,),
