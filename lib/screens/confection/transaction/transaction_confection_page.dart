...
class TransactionConfectionPage extends StatefulWidget {
  const TransactionConfectionPage({Key? key}) : super(key: key);

  @override
  State<TransactionConfectionPage> createState() => _TransactionConfectionPageState();
}

class _TransactionConfectionPageState extends State<TransactionConfectionPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: myDefaultAppBar('Transactions confection', context),
  ...
  Future<void> getAllTransactions() async {
    var request = http.Request('GET', Uri.parse("AdminRoutes.r_getTransactionConfectionUrl(widget.atelier.id!)"));
