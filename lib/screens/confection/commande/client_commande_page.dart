...
class ClientCommandePage extends StatefulWidget {
  final Client client;
  ClientCommandePage({Key? key, required this.client}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: isLoading? const LinearProgressIndicator(backgroundColor: Colors.transparent,) : Column(
        ...
        children: [
          ...
          const SizedBox(height: 15),
          Expanded(
              child: allClientCommandes.isNotEmpty?
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
                child: ListView.builder(
                    physics: const BouncingScrollPhysics(),
                    itemCount: allClientCommandes.length,
                    itemBuilder: (context, int index) => GestureDetector(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (_) => CommandeDetailsPage(commande: allClientCommandes[index], ligneCmdes: getLigneCommandes(allClientCommandes[index].id!),)));
                      },
                      child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Visibility(
                                              visible: true,
                                              child: textRaleway(allClientCommandes[index].etat!, 12, Colors.red, TextAlign.center),
                                            ),
                                          ),
                                          Container(
                                            width: 160,
                                            child:  textOpenSans("Cmde ${allClientCommandes[index].id}", 16, Colors.black, TextAlign.center),
                                          ),
                                          Container(
                                            width: 80,
                                            ...
                                            child: Visibility(
                                              visible: true,
                                              child: textWorkSans(allClientCommandes[index].ref!, 12, Colors.black26, TextAlign.right),
                                            ),
                                          ),
                                        ],
                                      ),
                                      ...
                                      Row(
                                        mainAxisAlignment: MainAxisAlignment.center,
                                        children: [
                                          textOpenSans(allClientCommandes[index].client!.toUpperCase(), 16, Colors.green, TextAlign.center),
                                        ],
                                      ),
                                      // Afficher les dates
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          textOpenSans("${Globals.convertDateEnToFr(allClientCommandes[index].date_commande!)}", 13, Colors.black45, TextAlign.center,fontWeight: FontWeight.bold),
                                          textOpenSans('Date Livr. : ', 11, Colors.black, TextAlign.center),
                                          textOpenSans("${Globals.convertDateEnToFr(allClientCommandes[index].date_prev_livraison!)}", 13, Colors.black45, TextAlign.center,fontWeight: FontWeight.bold),
                                        ],
                                      ),
                                      // Montant TTC
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Container(width: 100,alignment: Alignment.centerLeft, child: textOpenSans("${NumberFormat('#,###', 'fr_FR').format(allClientCommandes[index].montant_ttc)} ${CnxInfo.symboleMonnaie}", 15, Colors.black, TextAlign.center,fontWeight: FontWeight.bold)),
                                        ],
                                      ),
                                      // Montant Regle
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          const SizedBox(width: 4,),
                                          Container(width: 100,alignment: Alignment.centerLeft, child: textOpenSans("${NumberFormat('#,###', 'fr_FR').format(allClientCommandes[index].montant_recu)} ${CnxInfo.symboleMonnaie}", 15, Colors.black, TextAlign.center,fontWeight: FontWeight.bold)),
                                        ],
                                      ),
                                      // Montant Restant
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          const SizedBox(width: 4,),
                                          Container(width: 100, alignment: Alignment.centerLeft, child: textOpenSans("${NumberFormat('#,###', 'fr_FR').format(allClientCommandes[index].montant_ttc! - allClientCommandes[index].montant_recu!)} ${CnxInfo.symboleMonnaie}", 15, Colors.black, TextAlign.center,fontWeight: FontWeight.bold)),
                                        ],
                                      ),
                                    ],
                                  )
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: GestureDetector(
                                        onTap: () async {
                                          await Navigator.push(context, MaterialPageRoute(builder: (_) => ReglementPage(commande : allClientCommandes[index])));
                                          getCommandesList();
                                          getAllCmdeElements();
                                        },
                                        child: Container(
                                    ...
                                    Padding(
                                      ...
                                      child: GestureDetector(
                                        onTap:() async {
                                          await Navigator.push(context, MaterialPageRoute(builder: (context) => CommandeSavePage(pageMode: 'M', cmde: allClientCommandes[index], ligneCdes: getLigneCommandes(allClientCommandes[index].id!),)));
                                          getCommandesList();
                                          getAllCmdeElements();
                                        },
                                        child: Container(
                                    ...
                                    Padding(
                                      ...
                                      child: GestureDetector(
                                        onTap: () async {
                                          if (await msgBoxYesNo('Annulation', 'Opération irréversible, \nAnnuler cette commande (${allClientCommandes[index].ref!}) ?', context)) {
                                            cancelCommande(allClientCommandes[index].id!);
                                            getCommandesList();
                                            getAllCmdeElements();
                                          }
                                        },
